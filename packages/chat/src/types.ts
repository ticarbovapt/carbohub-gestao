...
export interface FeedPost {
  id: string; tipo: "kudos" | "aviso" | "aniversario"; body: string | null; created_at: string;
  image_path?: string | null; audience?: "all" | "departments" | "users"; audience_departments?: string[];
