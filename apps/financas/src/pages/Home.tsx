...
import { Wallet, CreditCard, ClipboardList, ArrowRight } from "lucide-react";
          ...
          <Link to="/requisicoes">
            <CarboCard className="hover:shadow-md transition-shadow cursor-pointer">
              <CarboCardContent className="p-4">
                <ClipboardList className="h-7 w-7 text-carbo-blue mb-2" />
                <p className="font-semibold">Requisições</p>
                <p className="text-sm text-muted-foreground mb-2">Aprovar/reprovar pedidos da operação e gerar OC.</p>
