...
// Retorno do OAuth do Bling: o Bling redireciona pra cá com ?code=...
// Trocamos o code por tokens (edge function bling-auth, action callback) e
// voltamos pra tela de integração. Substitui o callback que ficava no Controle.
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        setTimeout(() => navigate("/integracoes/bling"), 1800);
      } catch (err: any) {
        setStatus("error");
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-background">
      <div className="text-center space-y-4 p-8">
        ...
        {status === "error" && (
          <button onClick={() => navigate("/integracoes/bling")} className="text-carbo-green hover:underline">
