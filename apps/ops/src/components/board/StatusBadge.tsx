...
// Badge de status (fiel ao Controle: src/components/board/StatusBadge.tsx).
...
const statusConfig = {
  completed: { label: "Completo", className: "bg-success/10 text-success border-success/20" },
  pending: { label: "Pendente", className: "bg-warning/10 text-warning border-warning/20" },
  overdue: { label: "Atrasado", className: "bg-destructive/10 text-destructive border-destructive/20" },
  "in-progress": { label: "Em andamento", className: "bg-accent/20 text-accent-foreground border-accent/30" },
};
