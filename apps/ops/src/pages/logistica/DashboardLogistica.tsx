    ...
    <div className="p-4 md:p-6">
      <div className="space-y-6 max-w-[1500px] mx-auto">
        ...
        <Tabs defaultValue="kpis" className="w-full">
          ...
          <TabsContent value="operacional" className="space-y-4 mt-4"><ShipmentsKanban shipments={MOCK_SHIPMENTS} onView={(s) => toast(`Detalhes ${s.order_number} (em breve)`)} /></TabsContent>
