...
// Chave que o Admin concede (allowed_interfaces) para liberar o app Marketing.
// Mesmo modelo do Hub: carbo_mkt → Marketing.
const MKT_INTERFACE = "carbo_mkt";

/** Acesso ao Marketing: liberado pelo Admin (allowed_interfaces) OU gestão/TI. */
export function canAccess(p: Profile | null): boolean {
  ...
  return ifaces.map((i) => i.toLowerCase()).includes(MKT_INTERFACE);
}
