...
// Tipos de demanda: fonte única em @carbo/demandas, compartilhada com o botão
// de reporte dos seis apps. Reexporta para as telas do TI seguirem importando
// daqui e nada mais precisar mudar de lugar.
export { KINDS, kindOf, kindLabel, KIND_UI, kindUi } from "@carbo/demandas";
export type { KindConfig } from "@carbo/demandas";
