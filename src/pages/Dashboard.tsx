...
// Default dashboard component (existing implementation)
  ...
  return (
    <BoardLayout>
      ...
      <div className="mb-8 flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        <div>
          <h1 className="text-3xl font-semibold text-board-text">Dashboard</h1>
      ...
      <div className="rounded-xl border border-border bg-board-surface overflow-hidden">
          ...
          <table className="w-full">
            <thead>
              <tr className="border-b border-border bg-secondary/30">
                <th className="px-6 py-3 text-left text-xs font-semibold uppercase tracking-wider text-board-muted">
                  Departamento
                </th>
                <th className="px-6 py-3 text-left text-xs font-semibold uppercase tracking-wider text-board-muted">
                  OS
        ...
        <div className="flex items-center justify-between border-t border-border px-6 py-4">
          <p className="text-sm text-board-muted">
            {recentChecklists 
              ? `Mostrando ${recentChecklists.length} checklists recentes`
              : "Carregando..."}
          </p>
          <Button variant="board-ghost" size="sm">
            Ver todos
      ...
      {/* AI Assistant Card */}
      <div className="mt-8 rounded-xl border border-board-blue/20 bg-gradient-to-r from-board-blue/5 to-transparent p-6">
