...
// ── Static org tree — 30 colaboradores (Mapa_Responsabilidades_CarboVapt, aba Resumo) ──
export const STATIC_ORG_TREE: OrgNode[] = [
  makeNode("thelis", "Thelis Botelho", "CEO / Liderança Comercial", "Command", 1, [
    ...
    makeNode(
      "marina", "Marina O. Rodrigues",
      "Head — Estratégia, Marca e Crescimento",
      "Growth & B2B", 2,
      [
...
export const DEPT_COLORS: Record<string, string> = {
  ...
  OPS:          "#3b82f6",  // blue
  Growth:       "#22c55e",  // green
  "Growth & B2B": "#10b981", // emerald (dual dept)
